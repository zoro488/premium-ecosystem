...
// ============================================
// COMPONENTE: KPI ELEGANTE
// ============================================
const ElegantKPI = memo(({ title, value, icon: Icon, gradient }) => {
  return (
    <motion.div
      className="relative overflow-hidden rounded-xl p-6 backdrop-blur-sm bg-white/5 border border-white/5"
                ...
                <table className="w-full text-sm">
                  <thead className="border-b border-white/5">
                    <tr>
                      ...
                      <th className="px-3 py-2 text-left font-medium text-slate-400">Observaciones</th>
                    </tr>
                  </thead>
