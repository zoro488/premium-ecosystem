...
export default function FlowDistributor() {
  ...
  // Estados de datos con persistencia - VACÍO PARA PRODUCCIÓN
  const [bancos, setBancos] = useLocalStorage(STORAGE_KEYS.FLOW_BANCOS, {
    ...
    bovedaUSA: {
      ...
      gastos: [],
      transferencias: [],
      moneda: 'USD', // ⭐ NUEVO - Banco en dólares
    },
    utilidades: {
      nombre: 'Utilidades',
      capitalActual: 0,
      ...
      <div className="space-y-6 w-full min-h-screen bg-slate-900 p-8">
        ...
        >
          {dashboardKPIs.map((kpi, index) => (
            ...
            >
              {/* Efecto de brillo animado - OPTIMIZADO */}
              <motion.div
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-sm text-slate-400">{distribuidor.ordenes?.length || 0} órdenes</p>
                </div>
                <div
