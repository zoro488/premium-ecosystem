/**
 * 🚚 FORMULARIO DISTRIBUIDOR SIMPLIFICADO - SOLO NOMBRE
 *
 * Formulario rápido para crear distribuidores con:
...
import { AlertCircle, CheckCircle, Truck, X } from 'lucide-react';
...
// ============================================
export default function FormDistribuidorSimple({
  onClose,
  onSave,
  distribuidorExistente = null,
}: FormDistribuidorSimpleProps) {
  ...
  const {
    ...
    defaultValues: {
      nombre: distribuidorExistente?.nombre || '',
    },
  });
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="p-6 border-b border-chronos-smoke bg-gradient-to-r from-neon-purple/10 to-neon-cyan/10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-neon-purple/20 rounded-xl flex items-center justify-center">
                <Truck className="w-6 h-6 text-neon-purple" />
              </div>
              <div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              {...register('nombre')}
              type="text"
              placeholder="Ej: TechSupply México"
              disabled={isSubmitting}
            ...
            >
              ...
              <div>
                <div className="text-neon-green font-medium">
                  {distribuidorExistente ? '¡Distribuidor actualizado!' : '¡Distribuidor creado!'}
                </div>
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  ...
                  {distribuidorExistente ? 'Actualizar' : 'Crear Distribuidor'}
                </>
              )}
            </ChronosButton>
          </div>
