...
const IngresosBovedaUsaTable = memo(({ data }) => {
  const tableVariants = {
    hidden: { opacity: 0 },
    visible: {
      opacity: 1,
        ...
        <tbody>
          {data.map((ingreso, index) => (
            ...
            >
              ...
              <td className="px-6 py-4 text-slate-400">{ingreso.observaciones}</td>
...
IngresosBovedaUsaTable.displayName = 'IngresosBovedaUsaTable';

IngresosBovedaUsaTable.propTypes = {
  data: PropTypes.arrayOf(PropTypes.object).isRequired,
};

export default IngresosBovedaUsaTable;
