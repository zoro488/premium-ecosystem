...
export const escucharBancos = (callback) =>
  subscribeToCollection('bancos', callback, {
    userId: auth.currentUser?.uid,
  });
...
export const obtenerCuentasBancarias = () =>
  getDocuments('cuentas_bancarias', {
    userId: auth.currentUser?.uid,
  });
...
export const obtenerInversiones = () =>
  getDocuments('inversiones', {
    userId: auth.currentUser?.uid,
  });
...
export const obtenerMensajes = (conversacionId) =>
  getDocuments('mensajes', {
