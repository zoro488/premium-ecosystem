...
// ============================================
interface ChronosLogoFullProps {
  size?: number;
  animated?: boolean;
...
export function ChronosLogoFull({
  ...
  return (
    ...
    >
      ...
      >
        <line x1="35" y1="180" x2="35" y2="195" stroke="url(#chronos-gradient-primary)" strokeWidth="1" opacity="0.4" />
        <line x1="27.5" y1="187.5" x2="42.5" y2="187.5" stroke="url(#chronos-gradient-primary)" strokeWidth="1" opacity="0.4" />
      </motion.g>
    </motion.svg>
  );
}
...
// ============================================
export function ChronosLogoCompact({
  size = 120,
  animated = true,
  className = ''
}: {
...
// ============================================
export function ChronosLogoIcon({
  size = 60,
  animated = true,
  className = ''
}: {
  ...
  return (
    ...
    >
      ...
      >
        <line x1="30" y1="48" x2="30" y2="56" stroke="url(#chronos-icon-gradient)" strokeWidth="1" />
        <line x1="26" y1="52" x2="34" y2="52" stroke="url(#chronos-icon-gradient)" strokeWidth="1" />
      </motion.g>
    </motion.svg>
  );
}
...
// ============================================
export function ChronosLogoWithText({
  size = 300,
  logoVariant = 'full',
  className = ''
}: {
  size?: number;
  logoVariant?: 'full' | 'compact' | 'icon';
  className?: string;
}) {
  const LogoComponent = {
