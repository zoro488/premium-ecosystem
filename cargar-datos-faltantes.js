...
function leerJSON(nombre) {
  const filePath = path.join(__dirname, 'src', 'apps', 'FlowDistributor', 'data', `${nombre}-manual.json`);
...
async function main() {
  ...
  const colecciones = ['compras', 'distribuidores', 'clientes', 'ventas', 'gastos', 'almacen', 'bancos'];
