...
async function cargarLote3() {
  console.log('🔄 Cargando lote 3 (GYA101-GYA150)...');

  const jsonPath = join(__dirname, '..', 'datos_gya_lote3.json');
  ...
  console.log(`✅ Lote 3 completado: ${data.gastos_abonos.length} registros cargados`);
  console.log(`📊 Progreso: 150/306 (49.0%)`);
}
