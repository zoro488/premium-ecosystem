...
async function cargarLote1() {
  console.log('🔄 Cargando lote 1 (GYA001-GYA050)...');

  const jsonPath = join(__dirname, '..', 'datos_gya_lote1.json');
  ...
  console.log(`✅ Lote 1 completado: ${data.gastos_abonos.length} registros cargados`);
  console.log(`📊 Progreso: 50/306 (16.3%)`);
}
