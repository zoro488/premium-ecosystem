...
async function cargarLote6() {
  console.log('🔄 Cargando lote 6 (GYA251-GYA300)...');

  const jsonPath = join(__dirname, '..', 'datos_gya_lote6.json');
  ...
  console.log(`✅ Lote 6 completado: ${data.gastos_abonos.length} registros cargados`);
  console.log(`📊 Progreso: 300/306 (98.0%)`);
}
